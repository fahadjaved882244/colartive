...
class CustomNavigationBarState extends State<CustomNavigationBar>
  ...
  final List<NavigationItem> items = [
    NavigationItem(0, Icons.menu_outlined, 'Menu', AppColors.menuColor),
    NavigationItem(1, Icons.home_outlined, 'Home', AppColors.homeColor),
    NavigationItem(
        2, Icons.wallpaper_outlined, 'Saved', AppColors.galleryColor),
  ];
  @override
